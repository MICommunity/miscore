...
public class UnNormalizedCategoryScore extends ConfidenceScore {
    ...
    protected Map<String, Float> ontologyScore = new HashMap<>();
    protected Map<String, String> mappingParentTerms = new HashMap<>();
     ...
     */
    public UnNormalizedCategoryScore(List<String> listOfOntologyTerms) {
        restoreInitialState(listOfOntologyTerms);
    }

    public void restoreInitialState(List<String> listOfOntologyTerms) {
